<template>
  <div
    class="container mx-auto flex flex-col items-center justify-center gap-1 px-4 py-[15rem] text-center print:text-black"
  >
    ...
    <a
      href="/"
      class="mt-6 animate-pulse rounded-full bg-green-500 px-4 py-2 font-bold text-black transition-colors hover:bg-green-600 sm:w-[50%] md:w-[30%] lg:w-[20%]"
      >Take me home</a
    >
  </div>
</template>
