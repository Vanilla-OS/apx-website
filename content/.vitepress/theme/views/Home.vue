<template>
  ...
  <div class="mx-auto max-w-6xl px-4 pt-20 sm:px-6 lg:px-8">
    <div class="mb-10 flex flex-col gap-32 pb-44" id="main">
      <section id="what-is" class="flex flex-col items-center justify-center gap-8 text-center">
        <img src="/assets/components/decorations/ellipse-3.png" alt="Blurry Circle"
        ...
        <picture>
          <source media="(prefers-color-scheme: dark)" srcset="/assets/components/what-is-dark.svg" />
          <source media="(prefers-color-scheme: light)" srcset="/assets/components/what-is.svg" />
          <img alt="A diagram showing how Apx works" src="/assets/components/what-is.svg" class="lg:w-[50rem]" />
        </picture>
      </section>
      <section id="subsystems" class="flex flex-col flex-wrap items-center justify-center gap-12 lg:flex-row">
        <picture>
          <source media="(prefers-color-scheme: dark)" srcset="/assets/components/subsystems-dark.svg" />
          <source media="(prefers-color-scheme: light)" srcset="/assets/components/subsystems.svg" />
          <img src="/assets/components/subsystems.svg" alt="A diagram showing how Apx subsystems work"
            class="w-[10rem] lg:w-[25rem]" />
        </picture>
        <img src="/assets/components/decorations/ellipse-1.png" alt="Blurry Circle, decorative element"
          class="absolute left-0 w-[20rem] select-none lg:w-[40rem]" />
      ...
      <section id="vscode" class="flex flex-col flex-wrap items-center justify-center gap-12 text-center">
        <picture>
          <source media="(prefers-color-scheme: dark)" srcset="/assets/components/vscode-dark.svg" />
          <source media="(prefers-color-scheme: light)" srcset="/assets/components/vscode.svg" />
          <img src="/assets/components/vscode.svg"
      ...
      <section id="stack" class="flex flex-row flex-wrap items-center justify-center gap-12">
        <img src="/assets/components/decorations/ellipse-2.png" alt="Blurry Circle, decorative element"
          class="absolute left-0 mb-[20rem] w-[20rem] select-none lg:w-[40rem]" />
        <picture>
          <source media="(prefers-color-scheme: dark)" srcset="/assets/components/stack-dark.png" />
          <source media="(prefers-color-scheme: light)" srcset="/assets/components/stack.png" />
          <img src="/assets/components/stack.png"
        ...
        <div class="flex flex-col gap-4 text-center lg:text-left">
          ...
          <div class="flex flex-col gap-12 text-xl font-normal lg:w-[40rem] lg:text-2xl">
            <p>
      ...
      <section id="what-is" class="flex flex-col items-center justify-center gap-40 text-center">
        ...
        <img src="/assets/components/decorations/ellipse-3.png" alt="Blurry Circle, decorative element"
          class="absolute left-0 w-[20rem] select-none lg:w-[40rem]" />
        <div class="flex flex-row items-center justify-center gap-6 text-center lg:gap-20">
          <a href="https://rockylinux.org/" target="_blank" rel="noopener noreferrer">
            <img src="/assets/components/distributions/rocky.svg" alt="Rocky Linux"
          ...
          <a href="https://fedoraproject.org/" target="_blank" rel="noopener noreferrer">
            <img src="/assets/components/distributions/fedora.svg" alt="Fedora"
              class="w-16 transition-all duration-300 ease-in-out hover:scale-110 lg:w-[10rem]"
              style="filter: drop-shadow(0 0 0px transparent)"
          ...
          <a href="https://vanillaos.org/" target="_blank" rel="noopener noreferrer">
            <img src="/assets/components/distributions/vanilla.svg" alt="Vanilla OS"
          ...
          <a href="https://ubuntu.com/" target="_blank" rel="noopener noreferrer">
            <img src="/assets/components/distributions/ubuntu.svg" alt="Ubuntu"
              class="all w-16 duration-300 ease-in-out hover:scale-110 lg:w-[10rem]"
              style="filter: drop-shadow(0 0 0px transparent)"
          ...
          <a href="https://archlinux.org/" target="_blank" rel="noopener noreferrer">
            <img src="/assets/components/distributions/arch.svg" alt="Arch Linux"
              class="all w-16 duration-300 ease-in-out hover:scale-110 lg:w-[10rem]"
              style="filter: drop-shadow(0 0 0px transparent)"
