<template>
  <div class="relative flex h-[750px] w-screen items-center justify-center bg-cover bg-center"
    ...
    <div class="flex h-full flex-col items-center justify-between">
      <div class="relative z-10 flex h-full flex-col items-center justify-center gap-6 text-center">
        <div class="terminal flex flex-col items-start bg-black p-4 rounded-md text-green-400">
        ...
        <div ref="textContainer" class="mt-4 flex flex-col items-center gap-4">
          <h1 ref="typedText" class="max-w-[450px] text-4xl font-semibold leading-tight lg:text-6xl"></h1>
          <a href="https://docs.vanillaos.org/apx/en/getting-started"
            class="rounded-full mt-5 bg-white px-7 py-2 text-base font-medium text-black transition duration-200 hover:bg-green-500 lg:text-lg opacity-0"
            ref="gettingStartedButton">Getting Started</a>
        </div>
      </div>
      <a href="#what-is" class="z-10 mb-10 animate-bounce text-white text-opacity-40">
        <span class="material-symbols-outlined text-4xl transition duration-200 hover:text-white">
          keyboard_arrow_down
        </span>
      </a>
    </div>
